                    ...
                    <div class="mt-5">
                        <div class="invoice-container">
                            ...
                            <div class="invoice-details" id="invoice-details">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if ($hitung_harga == 30): ?>
                                                <?php number_format($hitung_jadi_harga = $pemesanan->harga * 1) ?>
                                                <?= 'Rp. ' . number_format($hitung_jadi_harga, 0, ',', '.') ?>
                                            <?php endif; ?>

                                            <!-- 3 BULAN -->
                                            <?php if ($hitung_harga == 90): ?>
                                                <?php number_format($hitung_jadi_harga = $pemesanan->harga * 3) ?>
                                                <?= 'Rp. ' . number_format($hitung_jadi_harga, 0, ',', '.') ?>
                                            <?php endif; ?>

                                            <!-- 6 BULAN -->
                                            <?php if ($hitung_harga == 180): ?>
                                                <?php number_format($hitung_jadi_harga = $pemesanan->harga * 6) ?>
                                                <?= 'Rp. ' . number_format($hitung_jadi_harga, 0, ',', '.') ?>=
                                            <?php endif; ?>

                                            <!-- 12 BULAN -->
                                            <?php if ($hitung_harga == 365): ?>
                                                <?php number_format($hitung_jadi_harga = $pemesanan->harga * 12) ?>
                                                <?= 'Rp. ' . number_format($hitung_jadi_harga, 0, ',', '.') ?>
                                            <?php endif; ?>
                                ...
                                <button class="btn btn-primary text-capitalize" onclick="printInvoice()">
